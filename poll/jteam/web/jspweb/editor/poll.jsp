...
JAXBContext pollContext = JAXBContext.newInstance(Pollsession.class);
	...
	"<img ALIGN=ABSMIDDLE src=\"../images/cmdMoveFirst.png\" onMouseover='navOver(\"cmdMoveFirst\")' onMouseout='navOut(\"cmdMoveFirst\")' onMousedown='navDown(\"cmdMoveFirst\")' onMouseup='navUp(\"cmdMoveFirst\")' name=\"cmdMoveFirst\" id=\"cmdMoveFirst\" class=\"navigation\"   onclick=\"$(\'#cmdMoveFirst\').page({direction : \'first\'})\">"+
    "<img ALIGN=ABSMIDDLE  src=\"../images/cmdMovePrevious.png\"  onMouseover='navOver(\"cmdMovePrevious\")' onMouseout='navOut(\"cmdMovePrevious\")' onMousedown='navDown(\"cmdMovePrevious\")' onMouseup='navUp(\"cmdMovePrevious\")' name=\"cmdMovePrevious\" id=\"cmdMovePrevious\" class=\"navigation\"   onclick=\"$(\'#cmdMovePrevious\').page({direction : \'previous\'})\">"+
    "<span id='position'></span>"+
    "<img ALIGN=ABSMIDDLE src=\"../images/cmdMoveNext.png\"  onMouseover='navOver(\"cmdMoveNext\")' onMouseout='navOut(\"cmdMoveNext\")' onMousedown='navDown(\"cmdMoveNext\")' onMouseup='navUp(\"cmdMoveNext\")' name=\"cmdMoveNext\" id=\"cmdMoveNext\" class=\"navigation\"    onclick=\"$(\'#cmdMoveNext\').page({direction : \'next\'})\">"+
    "<img ALIGN=ABSMIDDLE src=\"../images/cmdMoveLast.png\"  onMouseover='navOver(\"cmdMoveLast\")' onMouseout='navOut(\"cmdMoveLast\")' onMousedown='navDown(\"cmdMoveLast\")' onMouseup='navUp(\"cmdMoveLast\")' name=\"cmdMoveLast\" id=\"cmdMoveLast\" class=\"navigation\"   onclick=\"$(\'#cmdMoveLast\').page({direction : \'last\'})\">"+
    "</td></tr>"+
