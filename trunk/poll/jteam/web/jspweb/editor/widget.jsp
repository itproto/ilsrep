...
public String newWidget(String sessi, String user) throws Exception{
...
String output="";
	...
	"<tr style=\"display:none\" ><td style=\"display:none\" >Allow Test Mode</td><td><INPUT TYPE=\"checkbox\" id=\"TestMode\" NAME=\"TestMode\"  onclick=\"onTestMode()\"></td></tr>"+
	...
	"<tr id='customch' style=\"display:none\" ><td style=\"display:none\">Allow custom choice</td><td style=\"display:none\" colspan=2><INPUT TYPE=\"checkbox\" NAME=\"Custom\" id=\"Custom\"  > Not available in test mode</td></tr>"+
	"<tr id=\"navi\" style=\"text-align: center\"><td colspan=2>"+
	"<img ALIGN=ABSMIDDLE src=\"../images/cmdMoveFirst.png\"  style=\"display:none\" onMouseover='navOver(\"cmdMoveFirst\")' onMouseout='navOut(\"cmdMoveFirst\")' onMousedown='navDown(\"cmdMoveFirst\")' onMouseup='navUp(\"cmdMoveFirst\")' name=\"cmdMoveFirst\" id=\"cmdMoveFirst\" class=\"navigation\"  >"+
    "<img ALIGN=ABSMIDDLE  src=\"../images/cmdMovePrevious.png\"  style=\"display:none\" onMouseover='navOver(\"cmdMovePrevious\")' onMouseout='navOut(\"cmdMovePrevious\")' onMousedown='navDown(\"cmdMovePrevious\")' onMouseup='navUp(\"cmdMovePrevious\")' name=\"cmdMovePrevious\" id=\"cmdMovePrevious\" class=\"navigation\"   >"+
    "<span id='position' style=\"display:none\"></span>"+
    "<img ALIGN=ABSMIDDLE src=\"../images/cmdMoveNext.png\" style=\"display:none\" onMouseover='navOver(\"cmdMoveNext\")' onMouseout='navOut(\"cmdMoveNext\")' onMousedown='navDown(\"cmdMoveNext\")' onMouseup='navUp(\"cmdMoveNext\")' name=\"cmdMoveNext\" id=\"cmdMoveNext\" class=\"navigation\"    >"+
    "<img ALIGN=ABSMIDDLE src=\"../images/cmdMoveLast.png\" style=\"display:none\" onMouseover='navOver(\"cmdMoveLast\")' onMouseout='navOut(\"cmdMoveLast\")' onMousedown='navDown(\"cmdMoveLast\")' onMouseup='navUp(\"cmdMoveLast\")' name=\"cmdMoveLast\" id=\"cmdMoveLast\" class=\"navigation\"   >"+
    "</td></tr>"+
...
"<input type='hidden' name='result' id='result'><input type='hidden' id='svaeWidget' name='saveWidget' value=\"true\"></form>";
	if (user==null){
